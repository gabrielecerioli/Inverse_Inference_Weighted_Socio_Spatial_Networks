...
This repository provides reproducible implementations to generate synthetic spatio-functional networks and to infer the spatio-functional mixing parameter $\lambda \in [0, 1]$, the characteristic physical interaction scale $r > 0$, and the latent functional embedding coordinates $S \in \mathbb{R}^{N \times d_s}$.
...
- [`spatiosocial_network_generator.py`](spatiosocial_network_generator.py):
  ...
  - Convex combination of exponential spatial and functional kernels (Eq. A3) followed by doubly-balanced row normalization (Eq. A4) and Poisson link sampling (Eq. A5).
...
> Gabriele Cerioli and Adamo Cerioli (2026). *Inferring Latent Geometries in Weighted Spatio-Functional Networks*. arXiv: [2609.23933 [stat.ME]](https://arxiv.org/abs/2609.23933).

```bibtex
@article{cerioli2026inferring,
  title={Inferring Latent Geometries in Weighted Spatio-Functional Networks},
  author={Cerioli, Gabriele and Cerioli, Adamo},
  journal={arXiv preprint arXiv:2609.23933},
  year={2026},
  url={https://arxiv.org/abs/2609.23933}
}
```
